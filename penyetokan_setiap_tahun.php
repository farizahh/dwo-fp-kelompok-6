<html>
	<head>
		...
		<title>Penyetokan Setiap Tahun</title>
	...
	<body id="page-top">
				...
				<div id="content">
					...
					<div class="container-fluid">
						...
						<div class="d-sm-flex align-items-center justify-content-between mb-4">
							<h1 class="h3 mb-0 text-gray-800">Penyetokan Setiap Tahun Per Produk</h1>
						</div>
							...
							<div class="col-xl-8 col-lg-12">
								<div class="card shadow mb-4">
									...
									<div
										...
										<h6 class="m-0 font-weight-bold text-primary">Penyetokan Setiap Tahun Per Produk</h6>
									</div>
									<!-- Card Body -->
									<div class="card-body-store">
										<div class="chart-area-store">
											...
											$sql = "SELECT COUNT(stocked_quantity) AS stok FROM fact_production";
											$tot = mysqli_query($mysqli, $sql);
											$tot_amount = mysqli_fetch_row($tot);

											// Query Data Store dan Total Amountnya

											$sql = "SELECT CONCAT('name:',t.year) as tahun, CONCAT('y:', COUNT(fp.stocked_quantity)*100/" . $tot_amount[0] .") as y, CONCAT('drilldown:', t.year) as drilldown 
											FROM time t 
											...
											$sql = "SELECT t.year tahun, sum(fp.stocked_quantity) as tot_kat
											...
											$sql = "SELECT t.year tahun, p.product_name as produk, SUM(fp.stocked_quantity) as pendapatan_kat
											FROM time t
											JOIN fact_production fp ON (t.time_id = fp.time_id)
		...
		// Create the chart
			...
			title: {
				text: 'Persentase Penyetokan (AdventureWorks) Tiap Tahun Per Produk'},
				subtitle: {
					text:'Klik di potongan pie chart untuk melihat detil nilai penyetokan tiap produk'
				},
				accessibility: {
					announceNewData: {
						enabled: true
