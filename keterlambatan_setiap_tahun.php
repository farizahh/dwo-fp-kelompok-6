<html>
	<head>
		...
		<title>Keterlambatan Setiap Tahun</title>
	...
	<body id="page-top">
				...
				<div id="content">
					...
					<div class="container-fluid">
						...
						<div class="d-sm-flex align-items-center justify-content-between mb-4">
							<h1 class="h3 mb-0 text-gray-800">Keterlambatan Setiap Tahun</h1>
						</div>
							...
							<div class="col-xl-8 col-lg-12">
								<div class="card shadow mb-4">
									...
									<div
										...
										<h6 class="m-0 font-weight-bold text-primary">Keterlambatan Setiap Tahun</h6>
									</div>
									<!-- Card Body -->
									<div class="card-body-store">
										<div class="chart-area-store">
											...
											$sql = "SELECT CONCAT('name:',t.year) as tahun, CONCAT('y:', SUM(fp.keterlambatan)*100/" . $tot_amount[0] ." ) as y, CONCAT('drilldown:', t.year) as drilldown 
											FROM time t 
											JOIN fact_production fp ON (t.time_id = fp.time_id) 
											WHERE fp.keterlambatan < 0
											GROUP BY tahun 
											ORDER BY y DESC";
											...
											$sql = "SELECT t.year tahun, count(fp.keterlambatan) as tot_kat 
											...
											$sql = "SELECT t.year tahun, t.month as bulan, COUNT(fp.keterlambatan) as pendapatan_kat 
											FROM time t
											JOIN fact_production fp ON (t.time_id = fp.time_id)
											WHERE fp.keterlambatan < 0
		...
		// Create the chart
			...
			title: {
				text: 'Metode Pengiriman Setiap Tahun'},
				subtitle: {
					text:'Klik di potongan pie chart untuk melihat detil metode pengiriman setiap tahun'
				},
				accessibility: {
					announceNewData: {
						enabled: true
				...
				series: [
					{
						name: "Metode Pengiriman By Tahun",
						colorByPoint: true,
						data:
							<?php
