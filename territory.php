			...
			<div id="content-wrapper" class="d-flex flex-column">
				...
				<div id="content">
					...
					<div class="container-fluid">
						...
						<!-- Page Heading -->
						<h1 class="h3 mb-2 text-gray-800">Data Wilayah Customer</h1>
									...
									<div class="card-body-store">
										<div class="chart-area-store">
											...
											<?php
												...
												$database   = "adventureworks2023";
												$mysqli     = mysqli_connect($host, $user, $password, $database);
												$wilayah = mysqli_query($mysqli,"SELECT DISTINCT(territory_name), COUNT(fs.contact_id) as total FROM fact_sales fs JOIN territory tr ON fs.territory_id = tr.territory_id GROUP BY tr.territory_name ORDER BY total DESC");
