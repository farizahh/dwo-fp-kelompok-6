<html>
	<head>
		...
		<title>Pegawai yang Terlibat Setiap Tahun</title>
	...
	<body id="page-top">
				...
				<div id="content">
					...
					<div class="container-fluid">
						...
						<div class="d-sm-flex align-items-center justify-content-between mb-4">
							<h1 class="h3 mb-0 text-gray-800">Pegawai Yang Terlibat Penjualan Tiap Tahun</h1>
						</div>
							...
							<div class="col-xl-8 col-lg-12">
								<div class="card shadow mb-4">
									...
									<div
										...
										<h6 class="m-0 font-weight-bold text-primary">Pegawai Yang Terlibat Penjualan Tiap Tahun</h6>
									</div>
									<!-- Card Body -->
									<div class="card-body-store">
										<div class="chart-area-store">
											...
											$sql = "SELECT COUNT(contact_id) AS contact FROM fact_sales";
											$tot = mysqli_query($mysqli, $sql);
											$tot_amount = mysqli_fetch_row($tot);

											// Query Data Store dan Total Amountnya

											$sql = "SELECT CONCAT('name:',t.year) as tahun, CONCAT('y:', COUNT(fs.contact_id)*100/" . $tot_amount[0] .") as y, CONCAT('drilldown:', t.year) as drilldown 
											FROM time t 
											...
											$sql = "SELECT t.year tahun, count(fs.contact_id) as tot_kat
											FROM fact_sales fs
											...
											$sql = "SELECT t.year tahun, t.month as bulan, COUNT(fs.contact_id) as pendapatan_kat
											FROM time t
											JOIN fact_sales fs ON (t.time_id = fs.time_id)
		...
		// Create the chart
			...
			title: {
				text: 'Pegawai Penjualan Setiap Tahun'},
				subtitle: {
					text:'Klik di potongan pie chart untuk melihat detil pegawai terlibat penjualan setiap tahun nya'
				},
				accessibility: {
					announceNewData: {
						enabled: true
